...
import com.eldevs.githubusersmvp.databinding.ItemUserBinding

class UserAdapter(private val onItemClick: (UserItem) -> Unit) : ListAdapter<UserItem, UserAdapter.UserViewHolder>(
    UserDiffCallback
) {
